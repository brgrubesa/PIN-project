...
public class NVPAPICaller
{
    ...
    public string APIUsername = "sb-nzvof13764436_api1.business.example.com";
    private string APIPassword = "B7ERYUX5AR2CWYLP";
    private string APISignature = "ATDrmkMdjrW8WKQWZKdOLx5i1Ku1Awl-sTc7lIca-lAUPse17.3wteF4";
    ...
    public bool ShortcutExpressCheckout(string amt, ref string token, ref string retMsg)
    {
        ...
        using (ProjektPIN.Logic.ShoppingCartActions myCartOrders = new ProjektPIN.Logic.ShoppingCartActions())
        {
